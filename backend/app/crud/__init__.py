...
from app.crud.mood import get_usuario, get_usuario_by_telefono, get_usuarios, create_usuario
...
from app.crud.mood import (
    ...
    get_registro_habito, get_registros_habito_by_usuario, get_registros_habito_by_habito, create_registro_habito,
